...
import (
	"fmt"
	"gojvm/ch08/instructions/comparisons"
	"gojvm/ch08/instructions/constants"
	"gojvm/ch08/instructions/control"
	"gojvm/ch08/instructions/conversions"
	"gojvm/ch08/instructions/extended"
	"gojvm/ch08/instructions/loads"
	"gojvm/ch08/instructions/math"
	"gojvm/ch08/instructions/stack"
	"gojvm/ch08/instructions/stores"
	"gojvm/ch08/instructions/base"
	"gojvm/ch08/instructions/references"
)
