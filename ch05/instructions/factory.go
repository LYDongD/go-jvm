...
import (
	"fmt"
	"gojvm/ch05/instructions/comparisons"
	"gojvm/ch05/instructions/constants"
	"gojvm/ch05/instructions/control"
	"gojvm/ch05/instructions/conversions"
	"gojvm/ch05/instructions/extended"
	"gojvm/ch05/instructions/loads"
	"gojvm/ch05/instructions/math"
	"gojvm/ch05/instructions/stack"
	"gojvm/ch05/instructions/stores"
