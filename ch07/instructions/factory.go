...
import (
	"fmt"
	"gojvm/ch07/instructions/comparisons"
	"gojvm/ch07/instructions/constants"
	"gojvm/ch07/instructions/control"
	"gojvm/ch07/instructions/conversions"
	"gojvm/ch07/instructions/extended"
	"gojvm/ch07/instructions/loads"
	"gojvm/ch07/instructions/math"
	"gojvm/ch07/instructions/stack"
	"gojvm/ch07/instructions/stores"
	"gojvm/ch07/instructions/base"
	"gojvm/ch07/instructions/references"
)
