...
import (
	"fmt"
	"gojvm/ch06/instructions/comparisons"
	"gojvm/ch06/instructions/constants"
	"gojvm/ch06/instructions/control"
	"gojvm/ch06/instructions/conversions"
	"gojvm/ch06/instructions/extended"
	"gojvm/ch06/instructions/loads"
	"gojvm/ch06/instructions/math"
	"gojvm/ch06/instructions/stack"
	"gojvm/ch06/instructions/stores"
	"gojvm/ch06/instructions/base"
	"gojvm/ch06/instructions/references"
)
